...
import { Box, Dialog, DialogTitle, DialogContent, DialogActions, Paper, FormControlLabel, Checkbox, Typography, Grid, TextField, Button, Divider, IconButton } from "@mui/material";
  ...
  return (
    <Grid item xs={12} md={12}>
      <Box sx={{ textAlign: "center", position: "relative" }}>
        ...
        {/* <Divider sx={{ my: "0.5rem" }} /> */}
        <Typography sx={{ paddingTop: "1rem", paddingBottom: "1rem", textAlign: "start" }} variant="body1" gutterBottom>
          {user.bio}
        </Typography>
        <Typography variant="body1" gutterBottom sx={{ paddingTop: "0.4rem", paddingBottom: "0.4rem", display: "flex", flexDirection: "row", justifyContent: "start", alignItems: "center" }}>
          <InstagramIcon sx={{ marginRight: "0.5rem" }} />
          <MuiLink
        ...
        <Typography variant="body1" gutterBottom sx={{ paddingTop: "0.4rem", paddingBottom: "0.4rem", display: "flex", flexDirection: "row", justifyContent: "start", alignItems: "center" }}>
          <FacebookIcon sx={{ marginRight: "0.5rem" }} />
          <MuiLink href={user.socialProfiles.facebook} target="_blank" rel="noopener noreferrer" sx={{ textDecoration: "none", color: "black" }}>
            Facebook
          </MuiLink>
        </Typography>
        <Typography variant="body1" gutterBottom sx={{ paddingTop: "0.4rem", paddingBottom: "0.4rem", display: "flex", flexDirection: "row", justifyContent: "start", alignItems: "center" }}>
          <LanguageIcon sx={{ marginRight: "0.5rem" }} />
          <MuiLink href={user.socialProfiles.website} target="_blank" rel="noopener noreferrer" sx={{ textDecoration: "none", color: "black" }}>
            Website
          </MuiLink>
        </Typography>
        {/* <Typography variant="body1" gutterBottom sx={{ paddingTop: "0.4rem", paddingBottom: "0.4rem", display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
        ...
        <Dialog open={openPublicInformationDialog} onClose={handleClosePublicInformationDialog}>
          ...
          <DialogContent>
            ...
            <TextField fullWidth multiline rows="3" margin="normal" label="Bio" name="bio" value={user.bio} onChange={handleChange} />
            {/* <Typography variant="body1" gutterBottom sx={{ paddingTop: "0.4rem", paddingBottom: "0.4rem", display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
              <FacebookIcon sx={{ marginRight: "0.5rem" }} />
        ...
        <Grid container spacing={2} justifyContent="start">
          <Grid item xs={12} sm={12} md={12} lg={12}>
            <Box sx={{ position: "relative" }}>
              ...
              <IconButton sx={{ position: "absolute", top: 0, right: 0 }} variant="outlined" onClick={handleOpenUserPreferencesDialog}>
                <EditIcon />
              </IconButton>
            </Box>
            <Box sx={{ textAlign: "start", position: "relative" }}>
              <FormControl component="fieldset">
                <FormGroup>
                  <FormControlLabel disabled control={<Checkbox checked={false} onChange={() => {}} />} label="Receive notifications" />
                  <FormControlLabel disabled control={<Checkbox checked={false} onChange={() => {}} />} label="Receive newsletters" />
                  <FormControlLabel disabled control={<Switch />} label="Light Theme" />
                </FormGroup>
              </FormControl>
              <Box>
                <TextField disabled fullWidth type="text" margin="normal" label="Language" name="language" value={user.language} onChange={handleChange} />
                <TextField disabled fullWidth type="text" margin="normal" label="Country" name="country" value={user.country} onChange={handleChange} />
              </Box>
            </Box>
          </Grid>
        </Grid>
        ...
        <Box sx={{ textAlign: "center", position: "relative" }}>
          <Dialog open={openUserPreferencesDialog} onClose={handleCloseUserPreferencesDialog}>
            ...
            <DialogContent>
              <FormControl component="fieldset">
                <FormGroup>
                  <FormControlLabel control={<Checkbox checked={false} onChange={() => {}} />} label="Receive notifications" />
                  <FormControlLabel control={<Checkbox checked={false} onChange={() => {}} />} label="Receive newsletters" />
                  <FormControl>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <Box sx={{ position: "relative" }}>
            ...
            <IconButton sx={{ position: "absolute", top: 0, right: 0 }} variant="outlined" onClick={handleOpenUserCredentialsDialog}>
              <EditIcon />
            </IconButton>
          </Box>
          {/* <TextField fullWidth margin="normal" label="First Name" name="firstName" value={user.firstName} onChange={handleChange} />
          <TextField fullWidth margin="normal" label="Last Name" name="lastName" value={user.lastName} onChange={handleChange} /> */}
          <TextField disabled fullWidth margin="normal" label="Email" name="email" value={user.email} onChange={handleChange} />
          <TextField disabled fullWidth margin="normal" type="password" label="Password" name="password" value={user.password} onChange={handleChange} />
      ...
      <Box>
        <div>
          ...
          <Dialog open={openDialog} onClose={handleCloseDialog}>
            ...
            <DialogContent>
              <Typography>This action will permanently delete your account and all related data. Proceeding with this action cannot be undone.</Typography>
            </DialogContent>
            <DialogActions>
