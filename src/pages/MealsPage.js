...
// import React, { useState, useEffect } from "react";
// import { useParams, Link } from "react-router-dom";
// //import { useQueryParams } from "react-query-params"; // Correct import
...
// const MealsPage = () => {
//   // const { recipeTitle } = useQueryParams(); // Assuming you are using a hook like useQueryParams to get query parameters
//   // Parse query parameters using query-string
//   //const { recipeTitle } = queryString.parse(window.location.search);
//   const { id } = useParams();
//   const [meals, setMeals] = useState([]);
//   const [currentMeal, setCurrentMeal] = useState("");
//   const [loading, setLoading] = useState(true);
...
//         // const queryParams = new URLSearchParams();
//         // if (recipeTitle) {
//         //   queryParams.append("recipeTitle", recipeTitle);
//         // }
//         //const response = await fetch(`${BASE_URL}/meals/${id}/recipes`);
...
//   // const resetFilters = () => {
//   //   // Implement your logic to reset filters
//   //   console.log("Resetting Filters");
//   //   // Add logic to reset the state or make an API call to fetch all recipes
//   // };
...
//             />
//           </div>
//           {/* <img width={400} height={300} src={Desserts} alt={currentMeal.name} /> */}
//           {/* <img width={400} height={300} src={`../images/${currentMeal.name}.jpg`} alt={currentMeal.name} /> */}
//           {/* <img width={400} height={300} src={`./images/${currentMeal.name}.jpg`} alt={currentMeal.name} /> */}
//           {/* <img width={400} height={300} src={`${process.env.PUBLIC_URL}/logos/${currentMeal.name}.jpg`} alt={currentMeal.name} /> */}
